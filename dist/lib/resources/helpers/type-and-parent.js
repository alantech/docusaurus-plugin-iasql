                ...
                if (this.reflection) {
                    ...
                    if (this.reflection instanceof typedoc_1.SignatureReflection) {
                        if ((_b = (_a = this.reflection.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.url) {
                            md.push(getUrl((0, utils_1.camelToSnakeCase)(this.reflection.parent.parent.name), this.reflection.parent.parent.url));
                            if (this.reflection.parent.url) {
                                md.push(getUrl((0, utils_1.camelToSnakeCase)(this.reflection.parent.name), this.reflection.parent.url));
                            }
                        }
                    }
                    else {
                        if ((_c = this.reflection.parent) === null || _c === void 0 ? void 0 : _c.url) {
                            ...
                            if (this.reflection.url) {
                                md.push(getUrl((0, utils_1.camelToSnakeCase)(this.reflection.name), this.reflection.url));
                            }
                        }
                    }
                    return md.join(".");
